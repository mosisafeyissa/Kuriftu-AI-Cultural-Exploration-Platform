...
# CORS — allow all origins, methods, and headers (Flutter Web random ports)
...
# Storage Configuration (Full Cloudinary Migration)
STORAGES = {
    "default": {
...
# Explicitly define legacy settings for compatibility
...
CHAPA_LOGO_URL = "https://res.cloudinary.com/dgj7rttjf/image/upload/v1775304556/branding/app_logo.png"
